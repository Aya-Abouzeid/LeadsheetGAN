...
def get_placeholder(default_tensor=None, shape=None, name=None):
    """Return a placeholder_with_default if default_tensor given, otherwise a new placeholder is created and return"""
...
##def batch_norm(tensor_in, is_bn):
##    """
##    Apply a batch normalization layer on the input tensor and return the resulting tensor.
##
##    Args:
##        tensor_in (tensor): The input tensor.
##        is_bn (bool): Equals to is_training. True to train the parameter. False to fix the parameter. Defaults to True.
##
##    Returns:
##        tensor: The resulting tensor.
##
##    """
##    return tf.contrib.layers.batch_norm(tensor_in, decay=0.9, epsilon=1e-5, updates_collections=None, scale=True, is_training=is_bn)
...
def to_binary_tf(bar_or_track_bar, threshold=0.0, track_mode=False, melody=True):
